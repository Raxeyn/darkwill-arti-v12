...
const words = ['çikolata', 'odun', 'bomba', 'süt', 'şimşek', 'yıldırım', 'patlat', 'savaş', 'kelime', 'yok et', 'bilmem', 'darkwill', 'aşk', 'atatürk', 'biber', 'oyun', 'cam', 'intihar', 'baba', 'eşşek', 'kalk', 'uykucu', 'biberon', 'patates', 'ayı', 'sevgili', 'evlenme', 'düştüysen', 'makina', 'öldür', 'sonsuzluk', 'gerçek', 'kırmızı arabanın yanındaki mavi arabanın önündeki sarı arabanın yanindaki eflatun araba'];
